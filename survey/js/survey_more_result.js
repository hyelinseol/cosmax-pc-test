...
function surveyInputBomCode(result, type = null) {
  ...
  survey_jQuery(".subscribeBox").attr("product_no", survey_product_no);
...
function surveyQuantity(element, type) {
  ...
  survey_jQuery(".product_price").text(surveyComma(total_price) + "원"); 
...
function surveyBuyBtn() {
  ...
  survey_jQuery(".bottom_product_price").addClass("displaynone");
  survey_jQuery(".product_price").show();
...
function surveyCloseBtn() {
  ...
  survey_jQuery(".bottom_product_price").removeClass("displaynone");
  survey_jQuery(".product_price").hide();
  ...
  async function (event) {
    setTimeout(async function () {
      ...
      setTimeout(async function () {
        ...
        survey_jQuery(".product_price").text(surveyComma(price) + "원");
        survey_jQuery(".bottom_product_price").text(surveyComma(price) + "원");
