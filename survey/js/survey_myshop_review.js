  ...
  async function (event) {
    (async function (CAFE24API) {
      ...
      setTimeout(async function () {
        ...
        let survey_orders1 = await getSurveyOrder("N00,N10,N22,N20,N21,N30,N40,C00,C10,C34,C36,C40,C47,C48,C49,R00,R10,R12,R13,R30,R34,R36,R40,E00,E10,N01,E12,E13,E20,E30,E32,E34,E36,E40", start_date1, end_date1);
        let survey_orders2 = await getSurveyOrder("N00,N10,N22,N20,N21,N30,N40,C00,C10,C34,C36,C40,C47,C48,C49,R00,R10,R12,R13,R30,R34,R36,R40,E00,E10,N01,E12,E13,E20,E30,E32,E34,E36,E40", start_date2, end_date2);
        ...
        console.log("survey_order_list", survey_order_list);
        let html = "";
            ...
            <tr class="survey_order_area" order_id="${order_id}">
              ...
              <td class="product left">
                ...
                <div class="info">
                  ...
                  <div class="price">
                    <strong>${surveyComma(Number(product_price))}원</strong>
                    / ${product_quantity}개
                  </div>
                </div>
              </td>
