...
$(document).ready(function(){
    ...
    $("#main #header .shoppinginfo li a.cart").children('img').attr('src','/web/upload/mynomy/kr/layout/ico_recart_w.png');
    $("#main #header .shoppinginfo li a.log").children('img').attr('src','/web/upload/mynomy/kr/layout/ico_relog_w.png');
    $(window).scroll(function(){
        if($(window).scrollTop() > top_btn+40) {
            ...
            $("#main #header .shoppinginfo li a.cart").children('img').attr('src','/web/upload/mynomy/kr/layout/ico_recart.png');
            $("#main #header .shoppinginfo li a.log").children('img').attr('src','/web/upload/mynomy/kr/layout/ico_relog.png');
        }
        else {
